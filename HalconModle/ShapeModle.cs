...
namespace HalconModle
{
    public partial class ShapeModle : UserControl
    {
        ...
        private void UpdateParam(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(cmB_TrainContrast.Text, out int data))
            {
                m_paramTrain.Contrast = data;
            }
            else
            m_paramTrain.Contrast = cmB_TrainContrast.Text;

            if (int.TryParse(cmB_TrainMinContrast.Text, out  data))
            {
                m_paramTrain.MinContrast = data;
            }
            else
        ...
        private void btn_AddModleRegion_Click(object sender, EventArgs e)
        {
            ...
            {
                hDisplay1.AddRegion(EnumModelShapeType.Rectangle2, false);
                return;
            }
