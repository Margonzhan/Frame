...
namespace ViewROI
{
	...
	public class ROICircle : ROI
	{
       ...
       // public string regionColor = "green";
      //  public bool isSearchRegion = true;//2019/06/11

		public ROICircle(bool isSearch)
		{
        ...
        /// </summary>
        /// <returns></returns>
        public override bool GetIsSearchRegion()
        {
            return isSearchRegion;
        }
        public override double[] GetPosition()
        {
            double[] p = new double[] { midR, midC };
            return p;
        }
		/// <summary> 
        ...
        public override void SetCenterIndex()
        {
            activeHandleIdx = 1;
        }
		/// <summary> 
		...
		{
            return new HTuple(new double[] { midR, midC, 0, radius });
		}
