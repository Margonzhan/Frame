...
namespace HalWindow
{
    ...
    public partial class HDisplay : UserControl
    {
        ...
        public void AddRegion(EnumModelShapeType searchRegionShape,bool isSearchRegion)
        {
            if (searchRegionShape == EnumModelShapeType.Rectangle1)
            {
                roiController.setROIShape(new ROIRectangle1(isSearchRegion), 200, 200);
            }
            else if (searchRegionShape == EnumModelShapeType.Rectangle2)
            {
                roiController.setROIShape(new ROIRectangle2(isSearchRegion), 200, 200);
            }
            else if (searchRegionShape == EnumModelShapeType.Circle)
            {
                roiController.setROIShape(new ROICircle(isSearchRegion), 200, 200);
            }
            else if (searchRegionShape == EnumModelShapeType.Line)
            {
                roiController.setROIShape(new ROILine(isSearchRegion), 200, 200);
            }
            else if (searchRegionShape == EnumModelShapeType.Ring)
            {
    ...
    [Serializable]
    public enum EnumModelShapeType
    {
        /// <summary>
        /// 非可旋转矩形
        /// </summary>
